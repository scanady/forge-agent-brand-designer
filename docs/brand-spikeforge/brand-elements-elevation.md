...
### Shadow Color
All shadows use Midnight Ink (`#0B1220` / `rgb(11, 18, 32)`) at low opacity. This creates cool, cohesive shadows that complement the ink-based neutral palette.
...
| Attribute | Value |
|-----------|-------|
| Background | `rgba(11, 18, 32, 0.5)` — 50% Midnight Ink |
