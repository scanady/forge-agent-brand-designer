# Nexus Coach — Core Process Flows

> This document describes the day-to-day process flows for a coaching practice on Nexus Coach, written from the perspective of each user role. The goal is to define how processes **should** flow to guide system design — not to document current implementation state.
>
