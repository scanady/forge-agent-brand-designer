...
- **Brand-colored:** Drawn from the Nexus Coach palette (teal, slate, amber accents)
...
Human figures in Nexus Coach illustrations are abstract and inclusive.
...
|-------|----------------------|
| Guide Teal `#0F766E` | Primary subjects, active elements, connection lines |
| Teal 100 `#CCFBF1` | Teal background fills, highlight areas |
| Teal 50 `#F0FDFA` | Subtle fills, background panels |
| Structure Slate `#0F172A` | Text elements, high-contrast lines |
