...
- Clean, geometric forms that match Plus Jakarta Sans
...
| `--icon-emphasis` | `#0F172A` (Structure Slate) | High-emphasis, headings |
| `--icon-primary` | `#0F766E` (Guide Teal) | Active states, brand icons |
...
Icons organized by function within the Nexus Coach platform.
